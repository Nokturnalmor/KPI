...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_8.addWidget(self.tableWidget_kpi_sotr)
        ...
        self.pushButton_add_line = QtWidgets.QPushButton(self.tab_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_add_line.setMinimumSize(QtCore.QSize(0, 51))
        self.pushButton_add_line.setMaximumSize(QtCore.QSize(55, 55))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_add_line.setFont(font)
        self.pushButton_add_line.setObjectName("pushButton_add_line")
        self.horizontalLayout_8.addWidget(self.pushButton_add_line)
        self.pushButton_line_down = QtWidgets.QPushButton(self.tab_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_line_down.sizePolicy().hasHeightForWidth())
        self.pushButton_line_down.setSizePolicy(sizePolicy)
        self.pushButton_line_down.setMinimumSize(QtCore.QSize(0, 51))
        self.pushButton_line_down.setMaximumSize(QtCore.QSize(55, 55))
        font = QtGui.QFont()
        font.setFamily("Wingdings")
        font.setPointSize(14)
        self.pushButton_line_down.setFont(font)
        self.pushButton_line_down.setObjectName("pushButton_line_down")
        self.horizontalLayout_8.addWidget(self.pushButton_line_down)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_add_line.setText(_translate("MainWindow", "+"))
        self.pushButton_line_down.setText(_translate("MainWindow", "Ú"))
