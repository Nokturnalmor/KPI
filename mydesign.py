...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_save_sotr.setText("")
        self.pushButton_save_sotr.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButton_rasschet.setText("")
        self.pushButton_rasschet.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButton_save_vn.setStatusTip("")
        self.pushButton_save_vn.setText("")
        self.pushButton_save_vn.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButton_load_vn.setStatusTip("")
        self.pushButton_load_vn.setText("")
        self.pushButton_load_vn.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButton_save_red_kpi.setText("")
        self.pushButton_save_red_kpi.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButton_del_red_kpi.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButton_dell_line.setIconSize(QtCore.QSize(32, 32))
        ...
        self.tableWidget_struktura = QtWidgets.QTableWidget(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tableWidget_filtr = QtWidgets.QTableWidget(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tableWidget_filtr.sizePolicy().hasHeightForWidth())
        self.tableWidget_filtr.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.tableWidget_filtr.setFont(font)
        self.tableWidget_filtr.setObjectName("tableWidget_filtr")
        self.tableWidget_filtr.setColumnCount(0)
        self.tableWidget_filtr.setRowCount(0)
        self.verticalLayout_11.addWidget(self.tableWidget_filtr)
        ...
        self.pushButton_save_struktura.setText("")
        self.pushButton_save_struktura.setIconSize(QtCore.QSize(32, 32))
        self.pushButton_save_struktura.setObjectName("pushButton_save_struktura")
        self.verticalLayout_12.addWidget(self.pushButton_save_struktura)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_save_sotr.setToolTip(_translate("MainWindow", "Сохранить КПЭ"))
        self.pushButton_rasschet.setToolTip(_translate("MainWindow", "Рассчет КПЭ"))
        ...
        self.pushButton_save_vn.setToolTip(_translate("MainWindow", "Сохранить"))
        self.pushButton_load_vn.setToolTip(_translate("MainWindow", "Загрузить"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "КПЭвнеш."))
        self.pushButton_save_red_kpi.setToolTip(_translate("MainWindow", "Сохранить"))
        self.pushButton_del_red_kpi.setToolTip(_translate("MainWindow", "Удалить"))
        self.pushButton_line_up.setToolTip(_translate("MainWindow", "Поднять строку на уровень вверх"))
        self.pushButton_dell_line.setToolTip(_translate("MainWindow", "Удалить строку"))
        ...
        self.pushButton_save_struktura.setToolTip(_translate("MainWindow", "Сохранить"))
